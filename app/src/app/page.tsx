  ...
  const executiveCockpit = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KPICard title="Wallet Users" value={kpiVal('Wallet Users', '14.2M')} status="neutral" />
        <KPICard title="Monthly Active" value={kpiVal('Monthly Active', '8.7M')} status="neutral" />
        <KPICard title="Avg Balance" value={kpiVal('Avg Balance', '₱4,200')} status="neutral" />
        <KPICard title="Transactions (MTD)" value={kpiVal('Transactions (MTD)', '42M')} status="neutral" />
      </div>
  ...
  const domainTab1 = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <KPICard title="P2P Transfers" value={kpiVal('P2P Transfers', '₱84B')} />
        <KPICard title="Bill Payments" value={kpiVal('Bill Payments', '₱24B')} />
        <KPICard title="Merchant Spend" value={kpiVal('Merchant Spend', '₱18B')} />
      </div>
      <Chart
